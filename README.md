...
С помощью Gerard вы можете создавать новые модули, добавлять контроллеры, сервисы, миддлверы и многое другое всего одной командой.
...
* ✅ Автоматическая генерация контроллеров, сервисов, моделей, миддлверы, репозиториев, интерфейсов, конфигов
...
gerard.exe create:test <name> <module>                - Создать тест в модуле
